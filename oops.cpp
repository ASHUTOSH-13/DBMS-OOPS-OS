...
//the main aim of the oops is to bind together the data and function so that no other part could access the data except the function
...
// class in oops is blue print for the group of objects that share a common properties and behavior...
